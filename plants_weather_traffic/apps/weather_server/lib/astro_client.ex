defmodule Weather.AstroClient do
  use GenServer
  ...
  def create_socket(ip, port) do
    {:ok, sock} = :chumak.socket(:req, "astro-req" |> String.to_charlist())
  ...
  def handle_call(:alive, _from, {nil, %{}}) do
    {:reply, :false, {nil, %{}}}
  end

  def handle_call(:alive, _from, {sock, services}) do
    {:reply, isalive(sock), {sock, services}}
  end
